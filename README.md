...
- **2023 - Present**: B.Tech in Artificial Intelligence & Machine Learning, **Sanjay Ghodawat University**
- **2021 - 2023**: Diploma in Computer Engineering, **Dr. D. Y. Patil Polytechnic**



## Professional Experience

- **Software Developer Intern**, Anthaathi (Jul 2025 - Present)
- **Software Developer**, Prismas (Apr 2025 - Present)
- **Full Stack Developer**, Synfuse (Jan 2023 - Mar 2025)

  
## Tech Interests

- **Artificial Intelligence**: Large Language Models (LLMs), Computer Vision, Natural Language Processing
- **Full Stack Development**: Scalable Web Architectures, Real-time Database Integrations
- **Intelligent Systems**: Multi-agent Systems, AI-driven Insights

## Skills

- **Languages**: Python, JavaScript, TypeScript
- **AI/ML Frameworks**: TensorFlow, LangChain, HuggingFace API. Google Gemini API
- **Backend**: Node.js,Express. FastAPI,Firebase. MongoDB
- **Frontend**: React.js, Tailwind CSS. Framer Motion
- ***Tools***: Git, VS Code, Linux, Streamlit
